...
export class CategoryBrandVariantBaseSeeder {
  ...
  async createVariantTypes() {
    ...
    logger.info(
      `âœ… Created ${this.variantTypeCount} variant types with ${this.variantOptionCount} options`,
    );
  }
  ...
  async createBrands() {
    ...
    const brandsData = [
      ...
      {
        title: "Microsoft",
        description: "Software and hardware products",
        status: "active",
      },
      ...
      {
        title: "Wayfair",
        description: "Online furniture and home goods",
        status: "active",
      },
      {
        title: "West Elm",
      ...
      {
        title: "Sephora",
        description: "Beauty retailer and cosmetics",
        status: "active",
      },
      {
        title: "Clinique",
      ...
      },
      {
        ...
        description: "Outdoor recreation products",
        status: "active",
      },
      {
        title: "Patagonia",
      ...
      {
        title: "REI",
        description: "Outdoor gear and sporting goods",
        status: "active",
      },
    ];
        ...
        children: [
            ...
            children: [
              {
                ...
                summary: "Desktop PCs and workstations",
              },
              { title: "Laptops", summary: "Portable computers and notebooks" },
              {
                title: "Computer Accessories",
                summary: "Keyboards, mice, monitors, and more",
              },
          ...
          },
          {
            ...
            children: [
              {
                title: "Smartphones",
                summary: "Mobile phones and accessories",
              },
              {
                title: "Tablets",
                summary: "iPad, Android tablets, and accessories",
              },
              {
                title: "Smart Watches",
                summary: "Wearable technology and fitness trackers",
              },
              {
                title: "Mobile Accessories",
                summary: "Cases, chargers, and mobile accessories",
              },
            ],
          },
          {
            ...
            children: [
              {
                ...
                summary: "Audio devices and accessories",
              },
              {
                title: "Speakers",
                summary: "Bluetooth speakers and sound systems",
              },
              {
                title: "Gaming",
                summary: "Video games, consoles, and gaming accessories",
              },
              {
                title: "TV & Home Theater",
                summary: "Televisions and home entertainment",
              },
            ],
          },
        ],
        ...
        children: [
            ...
            children: [
              {
                ...
                summary: "Casual and dress shirts for men",
              },
              {
                title: "Pants & Jeans",
                summary: "Trousers, jeans, and casual pants",
              },
              { title: "Jackets & Coats", summary: "Outerwear and jackets" },
              {
                title: "Suits & Blazers",
                summary: "Formal wear and business attire",
              },
              {
                title: "Underwear & Sleepwear",
                summary: "Undergarments and pajamas",
              },
            ],
          },
          {
          ...
          },
          {
            ...
            children: [
              {
                title: "Men's Shoes",
                summary: "Dress shoes, sneakers, and boots for men",
              },
              {
                title: "Women's Shoes",
                summary: "Heels, flats, sneakers, and boots for women",
              },
        ...
        children: [
          {
            ...
            children: [
              {
                title: "Living Room",
                summary: "Sofas, chairs, and coffee tables",
              },
              { title: "Bedroom", summary: "Beds, dressers, and nightstands" },
              {
                title: "Dining Room",
                summary: "Dining tables, chairs, and storage",
              },
              {
                title: "Office Furniture",
                summary: "Desks, chairs, and office storage",
              },
              {
                title: "Outdoor Furniture",
                summary: "Patio and garden furniture",
              },
            ],
          },
          {
            ...
            children: [
              {
                title: "Wall Art",
                summary: "Paintings, prints, and wall decorations",
              },
              {
                title: "Lighting",
                summary: "Lamps, fixtures, and lighting accessories",
              },
              {
                title: "Rugs & Carpets",
                summary: "Floor coverings and area rugs",
              },
              {
                title: "Curtains & Blinds",
                summary: "Window treatments and accessories",
              },
            ],
          },
          {
            ...
            children: [
              {
                title: "Cookware",
                summary: "Pots, pans, and cooking utensils",
              },
              {
                title: "Small Appliances",
                summary: "Blenders, toasters, and kitchen gadgets",
              },
              {
                title: "Dinnerware",
                summary: "Plates, bowls, and serving pieces",
              },
              {
                title: "Kitchen Storage",
                summary: "Containers and organization solutions",
              },
            ],
          },
        ],
        ...
        children: [
          {
            ...
            children: [
              {
                title: "Face Makeup",
                summary: "Foundation, concealer, and face products",
              },
              {
                title: "Eye Makeup",
                summary: "Eyeshadow, mascara, and eye products",
              },
              {
                title: "Lip Makeup",
                summary: "Lipstick, lip gloss, and lip care",
              },
              {
                title: "Makeup Tools",
                summary: "Brushes, sponges, and beauty tools",
              },
            ],
          },
          {
            ...
            children: [
              {
                title: "Cleansers",
                summary: "Face wash and cleansing products",
              },
              {
                title: "Moisturizers",
                summary: "Face and body lotions and creams",
              },
              {
                title: "Serums & Treatments",
                summary: "Anti-aging and targeted skincare",
              },
              {
                title: "Sunscreen",
                summary: "UV protection and sun care products",
              },
            ],
          },
          {
            ...
            children: [
              {
                ...
                summary: "Hair cleansing and conditioning",
              },
              { title: "Hair Styling", summary: "Styling products and tools" },
              {
                title: "Hair Treatments",
                summary: "Deep conditioning and repair treatments",
              },
            ],
          },
        ],
            ...
            children: [
              {
                ...
                summary: "Athletic clothing for men",
              },
              {
                title: "Women's Activewear",
                summary: "Athletic clothing for women",
              },
              { title: "Sports Shoes", summary: "Athletic and running shoes" },
              {
                title: "Sports Accessories",
                summary: "Athletic gear and accessories",
              },
            ],
          },
          {
            ...
            children: [
              {
                title: "Camping Gear",
                summary: "Tents, sleeping bags, and camping equipment",
              },
              {
                title: "Hiking & Backpacking",
                summary: "Hiking gear and outdoor equipment",
              },
              {
                title: "Water Sports",
                summary: "Swimming, surfing, and water activities",
              },
            ],
          },
          {
            ...
            children: [
              {
                ...
                summary: "Treadmills, bikes, and cardio machines",
              },
              {
                title: "Strength Training",
                summary: "Weights, resistance, and strength equipment",
              },
              {
                title: "Yoga & Pilates",
                summary: "Mats, blocks, and yoga accessories",
              },
            ],
          },
        ],
...
export const categoryBrandVariantBaseSeeder =
  new CategoryBrandVariantBaseSeeder();
