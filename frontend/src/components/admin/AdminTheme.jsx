    ...
    return (
        <div className="flex h-[420px] items-center justify-center">
            <div className="admin-surface w-full max-w-md rounded-3xl p-10 text-center">
                <div className="mx-auto mb-5 h-16 w-16 animate-spin rounded-full border-[3px] border-primary-200 border-t-secondary-500 shadow-[0_0_0_4px_rgba(165,187,252,0.2)]" />
                <p className="text-lg font-semibold text-primary-800">{title}</p>
...
export const AdminPageHeader = ({
    ...
    return (
        <div className="admin-hero rounded-3xl p-6 text-white sm:p-8">
            <div className="absolute -right-10 -top-20 h-48 w-48 rounded-full bg-secondary-400/30 blur-3xl" />
            <div className="absolute -bottom-16 -left-8 h-44 w-44 rounded-full bg-primary-300/30 blur-3xl" />
            ...
            <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    {subtitle ? <p className="mt-2 text-primary-100">{subtitle}</p> : null}
                </div>
