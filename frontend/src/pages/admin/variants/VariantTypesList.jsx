                    ...
                    <tbody>
                        {items.map((item) => (
                            <tr key={item._id} className="border-b border-slate-100">
                                ...
                                <td className="py-3 pr-3 text-slate-700">{item.optionsCount ?? 0}</td>
                                ...
                                <td className="py-3 pr-3">
                                    <div className="flex justify-end gap-2">
                                        <button onClick={() => navigate(`/admin/variant-type/${item._id}/edit`)} className="rounded-lg bg-slate-900 px-3 py-1.5 text-xs font-semibold text-white hover:bg-slate-700">Edit</button>
                                        <button onClick={() => setTypeToDelete(item)} className="rounded-lg border border-rose-200 bg-rose-50 px-3 py-1.5 text-xs font-semibold text-rose-700 hover:bg-rose-100">Delete</button>
                                    </div>
                                </td>
                            </tr>
                        ))}
                        {items.length === 0 && (
                            <tr>
                                <td colSpan="6" className="py-8 text-center text-slate-500">No variant types found.</td>
                            </tr>
                        )}
                    </tbody>
                </table>
