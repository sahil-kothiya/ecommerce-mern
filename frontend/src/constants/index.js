export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    VARIANT_TYPES: "/api/v1/variant-types",
    VARIANT_OPTIONS: "/api/v1/variant-options",
...
export const SEO_CONFIG = {
  ...
  DEFAULT_DESCRIPTION:
    "Discover amazing products with our professional e-commerce platform built with modern technology.",
